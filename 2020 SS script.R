...
#  For instance 2020 stream projects enter "'SS20'".  This will pull the 
#  exclusion data for projects Z1SS2004, Z2SS2004, Z3SS2004, Z4SS2004, Z5SS2004,
#  and Z6SS2004 from the FDEP Oracle GWIS database table SITE_EVALUATIONs.
#  Be sure to enclose table name in double and then single quotes. 

# Example "'SS20'".

FDEPgetdata::getdata_fw_exclusions("'SS20'")
...
# Note that due to the COVID19 pandemic sampling was reduced.  For most zones sampling 
#  stopped after the fifth site was sampled.  The goal was to get at least a sample size
#  for thirty for the entire state.
...
#  target population.  Also, only 30.0% of the sample frame could actually be 
#  sampled. To estimate the percent of the target population that could be sampled, requires 
#  that the analysis be restricted to just sites in the target population, i.e., TNT = "T"
...
#  For example stream projects during year 2018 the entry would be "'SS18'"
#  Entering "'SS18','SS19','SS20'" for the variable will produce a dataframe for 
#  FDEP Status Streams sampled 2018 - 2020.
#  Be sure to enclose in double and single quotes.
#
# Water resource acronyms are CN = canals, LR = rivers, SS, = streams.

FDEPgetdata::getdata_results("'SS20'")
...
# Water quality analyses are based on 38 sites from the results file and must 
